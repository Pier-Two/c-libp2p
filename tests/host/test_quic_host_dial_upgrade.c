...
static libp2p_transport_err_t stub_quic_listen(libp2p_transport_t *self, const multiaddr_t *addr,
...
static libp2p_muxer_t *stub_muxer_factory(libp2p_host_t *host, libp2p_quic_session_t *session, const multiaddr_t *local,
