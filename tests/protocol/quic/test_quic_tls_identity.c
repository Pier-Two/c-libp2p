...
static const char CERT_ED25519[] = "308201ae30820156a0030201020204499602d2300a06082a8648ce3d04030230"
...
static const char CERT_ECDSA[] = "308201f63082019da0030201020204499602d2300a06082a8648ce3d04030230"
				 "2031123010060355040a13096c69627032702e696f310a300806035504051301"
				 "313020170d3735303130313133303030305a180f343039363031303131333030"
				 "30305a302031123010060355040a13096c69627032702e696f310a3008060355"
				 "04051301313059301306072a8648ce3d020106082a8648ce3d03010703420004"
...
static const char CERT_SECP256K1[] = "308201ba3082015fa0030201020204499602d2300a06082a8648ce3d04030230"
				     "2031123010060355040a13096c69627032702e696f310a300806035504051301"
				     "313020170d3735303130313133303030305a180f343039363031303131333030"
				     "30305a302031123010060355040a13096c69627032702e696f310a3008060355"
				     "04051301313059301306072a8648ce3d020106082a8648ce3d03010703420004"
...
static const char CERT_INVALID[] = "308201f73082019da0030201020204499602d2300a06082a8648ce3d04030230"
				   "2031123010060355040a13096c69627032702e696f310a300806035504051301"
				   "313020170d3735303130313133303030305a180f343039363031303131333030"
				   "30305a302031123010060355040a13096c69627032702e696f310a3008060355"
				   "04051301313059301306072a8648ce3d020106082a8648ce3d03010703420004"
...
static void expect_peer_id(const char *name, const char *hex_cert, const char *expected_peer,
			   uint64_t expected_key_type)
{
	...
	if (rc == LIBP2P_ERR_OK)
	{
		...
		TEST_TRUE(label, ident.key_type == expected_key_type, "expected key type %" PRIu64 ", got %" PRIu64,
		...
		if (str_err == PEER_ID_OK && str_len > 0U && str_len < sizeof(buf))
		{
			...
			TEST_TRUE(label, strcmp(buf, expected_peer) == 0, "expected %s, got %s", expected_peer, buf);
		}
...
int main(void)
{
	expect_peer_id("ED25519 certificate", CERT_ED25519, "12D3KooWM6CgA9iBFZmcYAHA6A2qvbAxqfkmrYiRQuz3XEsk4Ksv",
		       KEY_TYPE_ED25519);

	expect_peer_id("ECDSA certificate", CERT_ECDSA, "QmfXbAwNjJLXfesgztEHe8HwgVDCMMpZ9Eax1HYq6hn9uE",
		       KEY_TYPE_ECDSA);

	expect_peer_id("secp256k1 certificate", CERT_SECP256K1, "16Uiu2HAkutTMoTzDw1tCvSRtu6YoixJwS46S1ZFxW8hSx9fWHiPs",
		       KEY_TYPE_SECP256K1);
