...
extern libp2p_err_t libp2p_gossipsub__inject_frame(libp2p_gossipsub_t *gs, const peer_id_t *peer, const uint8_t *frame,
						   size_t frame_len);
...
int libp2p_gossipsub__topic_mesh_contains(libp2p_gossipsub_t *gs, const char *topic, const peer_id_t *peer,
					  int *out_outbound, uint64_t *out_last_heartbeat_ms);
libp2p_err_t libp2p_gossipsub__topic_mesh_add_peer(libp2p_gossipsub_t *gs, const char *topic, const peer_id_t *peer,
						   int outbound_hint);
libp2p_err_t libp2p_gossipsub__topic_mesh_remove_peer(libp2p_gossipsub_t *gs, const char *topic, const peer_id_t *peer);
...
int libp2p_gossipsub__topic_fanout_contains(libp2p_gossipsub_t *gs, const char *topic, const peer_id_t *peer,
					    int *out_outbound, uint64_t *out_last_publish_ms);
libp2p_err_t libp2p_gossipsub__topic_fanout_add_peer(libp2p_gossipsub_t *gs, const char *topic, const peer_id_t *peer,
						     int outbound_hint, uint64_t ttl_ms);
libp2p_err_t libp2p_gossipsub__topic_fanout_remove_peer(libp2p_gossipsub_t *gs, const char *topic,
...
libp2p_err_t libp2p_gossipsub__topic_set_publish_threshold(libp2p_gossipsub_t *gs, const char *topic, double threshold);
int libp2p_gossipsub__peer_has_subscription(libp2p_gossipsub_t *gs, const peer_id_t *peer, const char *topic);
int libp2p_gossipsub__topic_backoff_contains(libp2p_gossipsub_t *gs, const char *topic, const peer_id_t *peer);
...
libp2p_err_t encode_control_ihave_rpc(const char *topic, const uint8_t *msg_id, size_t msg_id_len, uint8_t **out_buf,
				      size_t *out_len);
int gossipsub_wait_for_peer_frame(libp2p_gossipsub_t *gs, const peer_id_t *peer, uint64_t timeout_ms,
				  size_t *out_frame_len);
int gossipsub_wait_for_peer_idle(libp2p_gossipsub_t *gs, const peer_id_t *peer, uint64_t duration_ms,
				 size_t *out_queue_len);
libp2p_err_t encode_graft_rpc(const char *topic, uint8_t **out_buf, size_t *out_len);
libp2p_err_t encode_peer_record_proto(const peer_id_t *peer, const multiaddr_t *const *addrs, size_t addr_count,
				      uint8_t **out_buf, size_t *out_len);
libp2p_err_t encode_signed_peer_record(const peer_id_t *peer, const multiaddr_t *const *addrs, size_t addr_count,
				       const uint8_t *secret_key, size_t secret_key_len, uint8_t **out_buf,
				       size_t *out_len);
...
libp2p_err_t encode_prune_rpc(const char *topic, int include_px, uint8_t **out_buf, size_t *out_len);
libp2p_err_t encode_control_iwant_rpc(const uint8_t *msg_id, size_t msg_id_len, uint8_t **out_buf, size_t *out_len);
libp2p_err_t first_byte_message_id_fn(const libp2p_gossipsub_message_t *msg, uint8_t **out_id, size_t *out_len,
				      void *user_data);
void gossipsub_service_free_env(gossipsub_service_test_env_t *env);
void gossipsub_test_score_update_cb(libp2p_gossipsub_t *gs, const libp2p_gossipsub_score_update_t *update,
				    void *user_data);
