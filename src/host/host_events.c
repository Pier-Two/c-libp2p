...
void libp2p__emit_incoming_error_with_peer(libp2p_host_t *host, const peer_id_t *peer, libp2p_err_t code,
					   const char *msg)
{
	if (!host)
		return;
...
void libp2p__notify_peer_protocols_updated(libp2p_host_t *host, const peer_id_t *peer, const char *const *protocols,
